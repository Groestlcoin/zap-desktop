...
export default defineMessages({
  ...
  lndconnect_description:
    'This QR Code can be used to connect other devices to your lnd node. It can be used with ZAP GRS iOS and ZAP GRS Android and any other wallet that supports the lndconnect standard.',
  lndconnect_warning:
